  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in duration-500 pb-24 px-4 pt-6">
      <header className="text-center space-y-2 mb-10">
        <h1 className="font-serif text-4xl font-bold text-slate-900 dark:text-cream-50">Statistiques</h1>
        <p className="text-slate-500 dark:text-slate-400">Analysez votre mémorisation du vocabulaire.</p>
      </header>

      <section className="bg-white dark:bg-slate-800 p-8 rounded-[32px] border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden">
        ...
        <h2 className="text-xl font-serif font-bold text-slate-800 dark:text-cream-50 mb-6 flex items-center gap-2">
           <Award className="w-5 h-5 text-brand-gold-dark" /> Vue Globale
        </h2>

        <div className="grid grid-cols-2 gap-4">
          <div className="bg-slate-50 dark:bg-slate-700/30 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
            <span className="text-4xl font-bold text-brand-emerald mb-2">{stats.mastered}</span>
            <span className="text-sm text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Mots Maîtrisés</span>
          </div>

          <div className="bg-slate-50 dark:bg-slate-700/30 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
            <span className="text-4xl font-bold text-brand-gold-dark mb-2">{streakData.currentStreak}</span>
            <span className="text-sm text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Jours de suite</span>
          </div>

          <div className="bg-slate-50 dark:bg-slate-700/30 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
            <span className="text-4xl font-bold text-brand-navy dark:text-brand-navy-light mb-2">{streakData.bestStreak}</span>
            <span className="text-sm text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">Record (Streak)</span>
          </div>

          <div className="bg-slate-50 dark:bg-slate-700/30 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 flex flex-col items-center justify-center text-center">
            <span className="text-4xl font-bold text-brand-emerald mb-2">{stats.learning}</span>
            <span className="text-sm text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">En cours d'app.</span>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white dark:bg-slate-800 p-8 rounded-[32px] border border-slate-200 dark:border-slate-700 shadow-sm relative overflow-hidden">
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-end mb-2">
            <span className="text-sm font-bold text-slate-600 dark:text-slate-300">Taux de maîtrise estimé</span>
          ...
          <div className="w-full h-4 bg-slate-100 dark:bg-slate-700 rounded-full overflow-hidden flex border border-slate-200 dark:border-slate-600">
            <div 
          ...
          <div className="flex justify-between text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mt-2">
